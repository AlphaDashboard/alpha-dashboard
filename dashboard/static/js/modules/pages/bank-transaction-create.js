import { TransactionForm } from '../transaction/transaction-form.js?v=147';
...
function init() {
    ...
    // Set default date if create mode (skip in view mode — data is loaded from API)
...
window.reinitBankTransaction = init;
