# Generated manually — Purchase Order Stored Procedure

from django.db import migrations


def create_sp_manage_purchase_order(apps, schema_editor):
    ...
    with schema_editor.connection.cursor() as cursor:
        ...
        cursor.execute("DROP PROCEDURE IF EXISTS sp_manage_purchase_order;")
...
def drop_sp_manage_purchase_order(apps, schema_editor):
    if schema_editor.connection.vendor != 'postgresql':
        return
    with schema_editor.connection.cursor() as cursor:
        cursor.execute("DROP PROCEDURE IF EXISTS sp_manage_purchase_order;")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dashboard', '0025_alter_voucher_options_alter_voucherfact_options_and_more'),
    ]

    operations = [
        migrations.RunPython(
            create_sp_manage_purchase_order,
            drop_sp_manage_purchase_order,
        ),
    ]
