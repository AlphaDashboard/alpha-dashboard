        ...
        with schema_editor.connection.cursor() as cursor:
            ...
            cursor.execute("""
                ...
                BEGIN
                    ...
                    ELSIF p_module = 'BANK_TRANSACTION' OR p_module = 'SUBSECTION_B2' OR p_module = 'SUBSECTION_Y' THEN
                        DECLARE
                        ...
                        BEGIN
                            ...
                            ELSIF p_operation = 'DELETE' THEN
                                IF v_module_type = 'B2' OR v_module_type = 'Y' THEN
                                    UPDATE "tblCASHBANK" SET
                                        status = FALSE,
                                        user_modified = p_user,
                                        date_modified = CURRENT_TIMESTAMP
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dashboard', '0028_rename_alphagroup_to_accountmaster'),
    ]
