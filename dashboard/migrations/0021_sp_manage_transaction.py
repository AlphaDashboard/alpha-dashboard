                    ...
                    IF p_module = 'SECTION_C' THEN
                        IF p_operation = 'INSERT' THEN
                            INSERT INTO "tblSectionC" (
                                "VoucherNo", "Date", "TranType", "RPID", "Amount", "Narration",
                                "BankAccount", "Status", "UserCreated", "DateCreated", "UserModified", "DateModified"
                            ) VALUES (
                            ...
                            INSERT INTO "tblSectionC_TRAN" (
                                "VoucherNo", "Date", "TranType", "RPID", alpha_group_id, "Amount",
                                "Remarks", "ChqNo", "ChqDate", "PayeeBank",
